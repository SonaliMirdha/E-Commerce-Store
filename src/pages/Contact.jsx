...
const Contact = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#b6daee] via-[#ebb3e3] to-[#c0d8aa] flex items-center justify-center px-4 py-10">
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        <h2 className="text-4xl font-bold text-gray-600 text-center mb-10">Get in Touch with <span className="text-red-400">E-Store</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-gray-600 space-y-6">
            <div>
              ...
              <p className="text-gray-500">Have a question or need support? We're here to help you with your electronics journey.</p>
            </div>
            <div>
              <p><strong>📍 Address:</strong> 187-A E-Store Bank, Raja Park, Jaipur 302001</p>
              <p><strong>📧 Email:</strong> support@estore.com</p>
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea rows="4" placeholder="Type your message..." className="w-full px-4 py-2 bg-white/20 border border-white/30 text-white rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
